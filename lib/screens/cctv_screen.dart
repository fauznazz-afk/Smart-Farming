          ...
          child: Row(
            children: [
              Icon(Icons.info_outline_rounded,
                  size: 19, color: primary.withValues(alpha: 0.9)),
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                const Text('Kamera siap ditampilkan',
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 15,
                        fontWeight: FontWeight.w700)),
                const SizedBox(height: 4),
                Text('Stream tidak berjalan sebelum Anda menekan Play',
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('Kamera tidak dapat dimuat',
